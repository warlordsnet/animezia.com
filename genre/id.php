...
<head>
    <title><?=$id?> on AnimeZia</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="<?=$id?> on AnimeZia">
    ...
    <meta property="og:title" content="<?=$id?> on AnimeZia">
    <meta property="og:description" content="<?=$id?> on AnimeZia in HD with No Ads. Watch anime online">
